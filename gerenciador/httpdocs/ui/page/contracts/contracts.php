            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="filter_name" class="form-control" name="filter_name" value="<?php print(isset($info["get"]["filter_name"]) ? $info["get"]["filter_name"] : "") ?>" class="MuiInputBase-input form-control" placeholder="Digite o Nome do Contrato">
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo Contrato</a>
                </div>
            </div>
            <hr>
        </form>
            ...
            <table class="table table-striped table-inverse table-hover">
                <thead class="thead-inverse">
                    <tr>
                        ...
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_name))) ?>">Nome do Contrato <i class="<?php print($ordenation_name_ordenation) ?>"></i></a></th>
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_description))) ?>">Descrição do Contrato <i class="<?php print($ordenation_description_ordenation) ?>"></i></a></th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tfoot>
                ...
                <tbody>
                    ...
                    if ($total > 0) {
                        ...
                        <tr>
                            <td colspan="8">
                                <p class="alert alert-danger text-center">Nenhum contrato encontrado...</p>
                            </td>
                        </tr>
                    <?php
                    }
...
<script>
    ...
    window.setTimeout(function() {
        jQuery("#btn_export").on("click", function() {
            jQuery("#frm_filter").prop({
                "action": "<?php print(set_url($GLOBALS["contracts_url"] . ".xls", $info["get"])) ?>"
            }).submit();
        })
    }, 1000);
    ...
    window.setTimeout(function() {
        jQuery("#btn_search").on("click", function() {
            jQuery("#frm_filter").prop({
                "action": "<?php print(set_url($GLOBALS["contracts_url"])) ?>"
            }).submit();
        })
    }, 1000);
</script>
