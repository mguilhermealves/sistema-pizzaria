...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#companies" aria-controls="companies" role="tab" data-toggle="tab">Empresas</a>
    </li>
</ul>
                ...
                <div class="col-lg-12 margin-top-10">
                    <table class="table table-striped table-inverse table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="checkbox" id="companies_id" name="companies_id"
                                        value="<?php print($v["idx"]) ?>"
                                        <?php print( in_array($v["idx"], $data ) ? 'checked="checked"' : '' ) ?> /></td>
                                <td scope="col"><?php print($v["idx"]) ?></td>
                                <td scope="col"><?php print($v["name"]) ?></td>
                            </tr>
                            <?php   }; ?>
                        </tbody>
                    </table>
