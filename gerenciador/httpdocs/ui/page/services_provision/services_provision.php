<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Prestação de Serviços</li>
    </ol>
</section>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-3">
                    <div class="form-group">
                        <label for="filter_name">Prestação de Serviço:</label>
                        <input type="text" id="filter_name" class="form-control" name="filter_name" value="<?php print(isset($info["get"]["filter_name"]) ? $info["get"]["filter_name"] : "") ?>" class="MuiInputBase-input form-control" placeholder="Ex:Folha de pagamento">
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-lg-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Nova Prestação de Serviço</a>
                </div>
            </div>
            <hr>
        </form>
            ...
            <table class="table table-striped table-inverse table-hover">
                <thead class="thead-inverse">
                    <tr>
                        ...
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_name))) ?>">Prestação de Serviço <i class="<?php print($ordenation_name_ordenation) ?>"></i></a></th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tfoot>
                ...
                <tbody>
                    ...
                    if ($total > 0) {
                        ...
                        <tr>
                            <td colspan="8">
                                <p class="alert alert-danger text-center">Nenhuma prestação de serviço encontrada...</p>
                            </td>
                        </tr>
                    <?php
                    }
