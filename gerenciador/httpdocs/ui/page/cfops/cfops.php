        ...
        <form class="col-lg-12 mb-4" id="frm_filter" method="GET" action="<?php print($form["pattern"]["search"]) ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo CFOP</a>
                </div>
            </div>
            <hr>
        </form>
            ...
            <table class="table table-striped table-inverse table-hover">
                ...
                <tbody>
                    ...
                    if ($total > 0) {
                        ...
                        <tr>
                            <td colspan="8">
                                <p class="alert alert-warning text-center">Nenhum CFOP encontrado...</p>
                            </td>
                        </tr>
                    <?php
                    }
