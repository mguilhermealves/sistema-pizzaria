            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="filter_name" class="form-control" name="filter_name" value="<?php print(isset($info["get"]["filter_name"]) ? $info["get"]["filter_name"] : "") ?>" class="form-control" placeholder="Digite o Nome do Grupo">
                    </div>
                </div>
                ...
                <div class="col-sm-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo Grupo</a>
                </div>
            </div>
            <hr>
        </form>
                    ...
                    if ($total > 0) {
                        foreach ($data as $v) { ?>
                            <tr>
                                ...
                                <td><?php print(count($v["clients_attach"])) ?></td>
                                <th>
                        ...
                        <tr>
                            <td colspan="5">
                                <p class="alert alert-warning text-center">Nenhum grupo encontrado...</p>
                            </td>
                        </tr>
                    <?php
                    }
