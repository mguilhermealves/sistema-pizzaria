            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="filter_name" class="form-control" name="filter_name" value="<?php print(isset($info["get"]["filter_name"]) ? $info["get"]["filter_name"] : "") ?>" class="form-control" placeholder="Digite o Nome do Serviço">
                    </div>
                </div>

                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="filter_istaxed">Tributado:</label>
                        <select class="form-control" id="filter_istaxed" name="filter_istaxed">
                            <option value="">--Selecione--</option>
                            <?php
                            foreach ($GLOBALS["yes_no_lists"] as $k => $v) {
                                printf('<option %s value="%s">%s</option>', isset($data["filter_istaxed"]) && $k == $data["filter_istaxed"] ? ' selected' : '', $k, $v);
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="col-sm-2">
                    ...
                    <a id="btn_add" class="btn btn-primary btn-block btn-sm" title="Adicionar" href="<?php print($form["pattern"]["new"]) ?>"><i class="bi bi-plus-circle"></i> Novo Serviço</a>
                </div>
            </div>
        </form>
        <!-- Container Begin -->
            ...
            <table class="table table-striped table-inverse table-hover">
                <thead class="thead-inverse">
                    <tr>
                        ...
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_istaxed))) ?>">Tributado <i class="<?php print($ordenation_istaxed_ordenation) ?>"></i></a></th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tfoot>
                    ...
                    if ($total > 0) {
                        foreach ($data as $v) { ?>
                            <tr>
                                ...
                                <td><?php print($GLOBALS["yes_no_lists"][$v["is_taxed"]]); ?></td>
                                <th>
                        ...
                        <tr>
                            <td colspan="5">
                                <p class="alert alert-warning text-center">Nenhum gerente encontrado...</p>
                            </td>
                        </tr>
                    <?php
                    }
