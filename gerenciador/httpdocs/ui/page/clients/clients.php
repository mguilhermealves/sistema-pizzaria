            ...
            <div class="row">
                <div class="col-sm-12 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="filter_name" class="form-control" name="filter_name" value="<?php print(isset($info["get"]["filter_name"]) ? $info["get"]["filter_name"] : "") ?>" class="MuiInputBase-input form-control" placeholder="Digite a Razão Social">
                    </div>
                </div>
                <div class="col-sm-12 col-lg-4">
                    <div class="form-group">
                        <label for="filter_cnpj">CPF:</label>
                        <input type="text" id="filter_cnpj" class="form-control document" name="filter_cnpj" value="<?php print(isset($info["get"]["filter_cnpj"]) ? $info["get"]["filter_cnpj"] : "") ?>" class="MuiInputBase-input form-control" placeholder="Digite o CNPJ">
                    </div>
                </div>
        ...
        <div class="col-sm-12 col-lg-12" style="overflow: auto;">
            ...
            <table class="table table-striped table-inverse table-hover">
                <thead class="thead-inverse">
                    <tr>
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_name))) ?>">Nome
                                <i class="<?php print($ordenation_name_ordenation) ?>"></i></a></th>
                        <th><a style="color:#707070; text-decoration:none" href="<?php print(set_url($form["pattern"]["search"], array("ordenation" => $ordenation_document))) ?>">CPF
                                <i class="<?php print($ordenation_document_ordenation) ?>"></i></a></th>
                        <th>Ações</th>
                    </tr>
                </thead>
                <tfoot>
                ...
                <tbody>
                    ...
                    if ($total > 0) {
                        foreach ($data as $v) { ?>
                            <tr>
                                <td><?php print(isset($v["last_name"]) ? $v["first_name"] . " " . $v["last_name"] : $v["first_name"]); ?></td>
                                <td class="cpf"><?php print(preg_replace("/(\d{3})(\d{3})(\d{3})(\d{2})/", "\$1.\$2.\$3-\$4", $v["cpf"])); ?></td>
                                <th>
