...
--
-- Table structure for table `clients_contracts`
--
...
--
-- Dumping data for table `clients_contracts`
--

LOCK TABLES `clients_contracts` WRITE;
/*!40000 ALTER TABLE `clients_contracts` DISABLE KEYS */;
/*!40000 ALTER TABLE `clients_contracts` ENABLE KEYS */;
UNLOCK TABLES;
