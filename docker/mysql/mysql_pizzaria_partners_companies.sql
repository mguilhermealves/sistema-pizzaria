...
--
-- Table structure for table `partners_companies`
--
...
--
-- Dumping data for table `partners_companies`
--

LOCK TABLES `partners_companies` WRITE;
/*!40000 ALTER TABLE `partners_companies` DISABLE KEYS */;
/*!40000 ALTER TABLE `partners_companies` ENABLE KEYS */;
UNLOCK TABLES;
